...
${HistoryEntryFieldsFragmentDoc}`,FindLabwareLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  historyGraph(
    ...
    ${GraphSvgFieldsFragmentDoc}`,FindMeasurementByBarcodeAndNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,GetAnalyserScanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetAnalyserScanData($barcode: String!) {
  analyserScanData(barcode: $barcode) {
    ...AnalyserScanDataFields
  }
}
    ${AnalyserScanDataFieldsFragmentDoc}`,GetBlockProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetCleanedOutAddressesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  comments(category: $commentCategory, includeDisabled: $includeDisabled) {
    ...
    ${CommentFieldsFragmentDoc}`,FindLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,GetConfigurationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${UserFieldsFragmentDoc}`,GetPrintersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetPrinters {
  printers {
    ...PrinterFields
  }
...
${SampleFieldsFragmentDoc}`,GetNextReplicateNumberDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  releaseColumnOptions {
    ...
    ${ReleaseFileOptionFieldsFragmentDoc}`,GetRecordInPlaceInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetRecordInPlaceInfo($category: String) {
  equipments(includeDisabled: false, category: $category) {
    ...EquipmentFields
  }
}
    ${EquipmentFieldsFragmentDoc}`,GetReleaseInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetSuggestedWorkForLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  suggestedWorkForLabware(barcodes: $barcodes, includeInactive: $includeInactive) {
    ...
    ${SuggestedWorkFieldsFragmentDoc}`,GetProgramsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetPrograms {
  programs {
    name
    enabled
...
${WorkTypeFieldsFragmentDoc}`,GetWorkTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addCostCode(code: $code) {
    ...
    ${CostCodeFieldsFragmentDoc}`,GetWorkProgressInputsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  releaseRecipients(includeDisabled: true) {
    ...
    `,AddExternalIdDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addOmeroProject(name: $name) {
    ...
    ${OmeroProjectFieldsFragmentDoc}`,AddHmdmcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,DestroyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addEquipment(category: $category, name: $name) {
    ...
    ${EquipmentFieldsFragmentDoc}`,EmptyLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,LoginDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  login(username: $username, password: $password) {
    ...
    ${UserFieldsFragmentDoc}`,PerformParaffinProcessingDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetCommentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setHmdmcEnabled(hmdmc: $hmdmc, enabled: $enabled) {
    ...
    ${HmdmcFieldsFragmentDoc}`,SetProbePanelEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetProbePanelEnabled($name: String!, $enabled: Boolean!) {
  setProbePanelEnabled(name: $name, enabled: $enabled) {
    ...ProbePanelFields
  }
}
    ${ProbePanelFieldsFragmentDoc}`,SetLocationCustomNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,SetOmeroProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setFixativeEnabled(name: $name, enabled: $enabled) {
    ...
    ${FixativeFieldsFragmentDoc}`,SetReleaseDestinationEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProgramEnabled(name: $name, enabled: $enabled) {
    ...
    ${ProgramFieldsFragmentDoc}`,SetSpeciesEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setSlotRegionEnabled(name: $name, enabled: $enabled) {
    ...
    ${SlotRegionFieldsFragmentDoc}`,StoreDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,UnreleaseDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
