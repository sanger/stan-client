"use strict";(self.webpackChunkclient=self.webpackChunkclient||[]).push([[523],{"./src/lib/helpers.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{CI:()=>disabledBackgroundColorClassNames,EF:()=>backgroundColorClassNames,Kn:()=>LabwareDirection,Lb:()=>mapify,_f:()=>GridDirection,sn:()=>isSameArray,uv:()=>objectKeys,wz:()=>regexSort,x:()=>buildAddresses,yX:()=>Position});var _types_sdk__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/types/sdk.ts");__webpack_require__("./node_modules/lodash/lodash.js");function objectKeys(o){return Object.keys(o)}function*cycle(list){let i=0;const l=list.length;for(;;)yield list[i],i+=1,i===l&&(i=0)}let GridDirection=function(GridDirection){return GridDirection.RightDown="RightDown",GridDirection.DownRight="DownRight",GridDirection.RightUp="RightUp",GridDirection.UpRight="UpRight",GridDirection.LeftUp="LeftUp",GridDirection}({}),LabwareDirection=function(LabwareDirection){return LabwareDirection.Horizontal="Horizontal",LabwareDirection.Vertical="Vertical",LabwareDirection}({}),Position=function(Position){return Position.TopRight="TopRight",Position.BottomRight="BottomRight",Position.TopLeft="TopLeft",Position.BottomLeft="BottomLeft",Position.Right="Right",Position.Left="Left",Position}({});function createAddress(rowNumber,columnNumber){if(rowNumber>26)return`${rowNumber},${columnNumber}`;const aCharCode="A".charCodeAt(0);return`${String.fromCharCode(rowNumber+aCharCode-1)}${columnNumber}`}function buildAddresses(size){let direction=arguments.length>1&&void 0!==arguments[1]?arguments[1]:GridDirection.RightDown;const{numRows,numColumns}=size,addresses=new Array;switch(direction){case GridDirection.RightDown:for(let row=1;row<=numRows;row++)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.DownRight:for(let col=1;col<=numColumns;col++)for(let row=1;row<=numRows;row++)addresses.push(createAddress(row,col));break;case GridDirection.RightUp:for(let row=numRows;row>=1;row--)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.LeftUp:for(let row=numRows;row>=1;row--)for(let col=numColumns;col>=1;col--)addresses.push(createAddress(row,col));break;default:throw new Error(`Unsupported direction: ${direction}`)}return addresses}const COLORS=["red","green","indigo","pink","blue","purple"];function backgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-500`)))}function disabledBackgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-200`)))}function mapify(items,key){return new Map(items.map((item=>[item[key],item])))}function regexSort(a,b,regExp){let aPrim,aSec,bPrim,bSec,alphaFirst=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],aAlpha=aPrim=a.replace(regExp.alpha,"");const bAlpha=bPrim=b.replace(regExp.alpha,""),aNumericVal=a.replace(regExp.numeric,""),bNumericVal=b.replace(regExp.numeric,""),aNumeric=aSec=""!==aNumericVal?parseInt(aNumericVal,10):Number.MAX_VALUE,bNumeric=bSec=""!==bNumericVal?parseInt(bNumericVal,10):Number.MAX_VALUE;return alphaFirst||(aPrim=aNumeric,bPrim=bNumeric,aSec=aAlpha,bSec=bAlpha),aPrim===bPrim?aSec===bSec?0:aSec>bSec?1:-1:aPrim>bPrim?1:-1}function isSameArray(array1,array2){return array1.length===array2.length&&array1.every((element=>array2.includes(element)))}Object.values(_types_sdk__WEBPACK_IMPORTED_MODULE_0__.JqL).map((val=>({value:val,label:val})))},"./src/types/sdk.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{IoU:()=>LabwareState,JqL:()=>SlideCosting,NN7:()=>LifeStage,W_V:()=>PassFail,ZpU:()=>FlagPriority,mDe:()=>ControlType,xMG:()=>getSdk});var graphql_request__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/graphql-request/build/esm/index.js");let LabwareState=function(LabwareState){return LabwareState.Empty="empty",LabwareState.Active="active",LabwareState.Discarded="discarded",LabwareState.Released="released",LabwareState.Destroyed="destroyed",LabwareState.Used="used",LabwareState}({}),PassFail=function(PassFail){return PassFail.Pass="pass",PassFail.Fail="fail",PassFail}({}),ControlType=function(ControlType){return ControlType.Positive="positive",ControlType.Negative="negative",ControlType}({}),LifeStage=function(LifeStage){return LifeStage.Adult="adult",LifeStage.Paediatric="paediatric",LifeStage.Fetal="fetal",LifeStage}({}),SlideCosting=function(SlideCosting){return SlideCosting.Faculty="Faculty",SlideCosting.Sgp="SGP",SlideCosting.WarrantyReplacement="Warranty_replacement",SlideCosting}({}),FlagPriority=function(FlagPriority){return FlagPriority.Note="note",FlagPriority.Flag="flag",FlagPriority}({});graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addEquipment(category: $category, name: $name) {
    ...
    ${EquipmentFieldsFragmentDoc}`,AddDestructionReasonDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addExternalID(request: $request) {
    ...
    `,AddProbePanelDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddProbePanel($type: ProbeType!, $name: String!) {
  addProbePanel(type: $type, name: $name) {
    ...ProbePanelFields
  }
}
    ${ProbePanelFieldsFragmentDoc}`,AddFixativeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProject(name: $name) {
    ...
    ${ProjectFieldsFragmentDoc}`,AddProgramDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addSlotRegion(name: $name) {
    ...
    ${SlotRegionFieldsFragmentDoc}`,AddOmeroProjectDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddOmeroProject($name: String!) {
  addOmeroProject(name: $name) {
    ...OmeroProjectFields
  }
}
    ${OmeroProjectFieldsFragmentDoc}`,AddSpatialLocationsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addSpecies(name: $name) {
    ...
    ${SpeciesFieldsFragmentDoc}`,AddTissueTypeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,AddUserDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addWorkType(name: $name) {
    ...
    ${WorkTypeFieldsFragmentDoc}`,DestroyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,LoginDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  login(username: $username, password: $password) {
    ...
    ${UserFieldsFragmentDoc}`,ExtractDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${PlanActionFieldsFragmentDoc}`,PerformTissueBlockDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,FlagLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addCostCode(code: $code) {
    ...
    ${CostCodeFieldsFragmentDoc}`,RecordInPlaceDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,RecordVisiumQcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setCostCodeEnabled(code: $code, enabled: $enabled) {
    ...
    ${CostCodeFieldsFragmentDoc}`,SetEquipmentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetEquipmentEnabled($equipmentId: Int!, $enabled: Boolean!) {
  setEquipmentEnabled(equipmentId: $equipmentId, enabled: $enabled) {
    ...EquipmentFields
  }
}
    ${EquipmentFieldsFragmentDoc}`,SaveSlotCopyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  registerAsEndUser(username: $username, password: $password) {
    ...
    ${UserFieldsFragmentDoc}`,SetBioRiskEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetBioRiskEnabled($code: String!, $enabled: Boolean!) {
  setBioRiskEnabled(code: $code, enabled: $enabled) {
    ...BioRiskFields
  }
}
    ${BioRiskFieldsFragmentDoc}`,SetFixativeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setDestructionReasonEnabled(text: $text, enabled: $enabled) {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,SetProgramEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetProgramEnabled($name: String!, $enabled: Boolean!) {
  setProgramEnabled(name: $name, enabled: $enabled) {
    ...ProgramFields
  }
}
    ${ProgramFieldsFragmentDoc}`,SegmentationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetCellClassEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setCellClassEnabled(name: $name, enabled: $enabled) {
    ...
    ${CellClassFieldsFragmentDoc}`,SetOpWorkRequestDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${UserFieldsFragmentDoc}`,SetLocationCustomNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,TransferLocationItemsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,UpdateReleaseRecipientFullNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateReleaseRecipientFullName(username: $username, fullName: $fullName) {
    ...
    ${ReleaseRecipientFieldsFragmentDoc}`,StainDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,VisiumAnalysisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cleanOut(request: $request) {
    ...
    `,SetReleaseDestinationEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setWorkTypeEnabled(name: $name, enabled: $enabled) {
    ...
    ${WorkTypeFieldsFragmentDoc}`,RecordOpWithSlotMeasurementsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  listFiles(workNumbers: $workNumbers) {
    ...
    ${FileFieldsFragmentDoc}`,FindHistoryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${FlagBarcodesFieldsFragmentDoc}`,FindDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  find(request: $request) {
    ...
    `,FindHistoryForDonorNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${FlagBarcodesFieldsFragmentDoc}`,FindHistoryGraphDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  historyGraph(
    ...
    ${GraphSvgFieldsFragmentDoc}`,FindHistoryForExternalNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,FindHistoryForWorkNumberDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}
${HistoryEntryFieldsFragmentDoc}
${FlagBarcodesFieldsFragmentDoc}`,FindPlanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${PlanActionFieldsFragmentDoc}`,FindPassFailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,FindReagentPlateDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SamplePositionFieldsFragmentDoc}`,FindLabwareLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  location(locationBarcode: $barcode) {
    ...
    ${LocationFieldsFragmentDoc}
${LinkedLocationFieldsFragmentDoc}`,FindWorksCreatedByDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,CurrentUserDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  user {
    ...
    ${UserFieldsFragmentDoc}`,FindMeasurementByBarcodeAndNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkProgressTimeStampFieldFragmentDoc}`,FindWorkNumbersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetCommentsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  destructionReasons {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,GetDestructionReasonsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetDestructionReasons($includeDisabled: Boolean) {
  destructionReasons(includeDisabled: $includeDisabled) {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,GetCleanedOutAddressesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CellClassFieldsFragmentDoc}`,FindSamplePositionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query FindSamplePositions($labwareBarcode: String!) {
  samplePositions(labwareBarcode: $labwareBarcode) {
    ...SamplePositionFields
  }
}
    ${SamplePositionFieldsFragmentDoc}`,GetAnalyserScanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(category: $category, includeDisabled: $includeDisabled) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetDnapStudyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetDnapStudy($ssId: Int!) {
  dnapStudy(ssId: $ssId) {
    ...DnapStudyFields
  }
}
    ${DnapStudyFieldsFragmentDoc}`,GetNextReplicateNumberDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetNextReplicateNumber($barcodes: [String!]!) {
  nextReplicateNumbers(barcodes: $barcodes) {
    ...NextReplicateDataFields
  }
}
    ${NextReplicateDataFieldsFragmentDoc}`,GetLabwareCostingDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${UserFieldsFragmentDoc}`,GetOmeroProjectsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetPrintersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  printers {
    ...
    ${PrinterFieldsFragmentDoc}`,GetRecordInPlaceInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  storagePath(locationBarcode: $locationBarcode) {
    ...
    ${LinkedLocationFieldsFragmentDoc}`,GetProbePanelsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cellClasses {
    ...
    ${LabwareTypeFieldsFragmentDoc}`,GetOperationTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  slotRegions(includeDisabled: false) {
    ...
    ${CommentFieldsFragmentDoc}
${SlotRegionFieldsFragmentDoc}`,GetReleaseColumnOptionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,GetWorkNumbersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}
${CommentFieldsFragmentDoc}`,GetSolutionTransferInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  comments: comments(includeDisabled: false, category: "Sample Processing") {
    ...
    ${CommentFieldsFragmentDoc}`,GetWorkSummaryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
