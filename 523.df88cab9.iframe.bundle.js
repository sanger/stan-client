"use strict";(self.webpackChunkclient=self.webpackChunkclient||[]).push([[523],{"./src/lib/helpers.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{CI:()=>disabledBackgroundColorClassNames,EF:()=>backgroundColorClassNames,Kn:()=>LabwareDirection,Lb:()=>mapify,_f:()=>GridDirection,sn:()=>isSameArray,uv:()=>objectKeys,wz:()=>regexSort,x:()=>buildAddresses,yX:()=>Position});var _types_sdk__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/types/sdk.ts");__webpack_require__("./node_modules/lodash/lodash.js");function objectKeys(o){return Object.keys(o)}function*cycle(list){let i=0;const l=list.length;for(;;)yield list[i],i+=1,i===l&&(i=0)}let GridDirection=function(GridDirection){return GridDirection.RightDown="RightDown",GridDirection.DownRight="DownRight",GridDirection.RightUp="RightUp",GridDirection.UpRight="UpRight",GridDirection.LeftUp="LeftUp",GridDirection}({}),LabwareDirection=function(LabwareDirection){return LabwareDirection.Horizontal="Horizontal",LabwareDirection.Vertical="Vertical",LabwareDirection}({}),Position=function(Position){return Position.TopRight="TopRight",Position.BottomRight="BottomRight",Position.TopLeft="TopLeft",Position.BottomLeft="BottomLeft",Position.Right="Right",Position.Left="Left",Position}({});function createAddress(rowNumber,columnNumber){if(rowNumber>26)return`${rowNumber},${columnNumber}`;const aCharCode="A".charCodeAt(0);return`${String.fromCharCode(rowNumber+aCharCode-1)}${columnNumber}`}function buildAddresses(size){let direction=arguments.length>1&&void 0!==arguments[1]?arguments[1]:GridDirection.RightDown;const{numRows,numColumns}=size,addresses=new Array;switch(direction){case GridDirection.RightDown:for(let row=1;row<=numRows;row++)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.DownRight:for(let col=1;col<=numColumns;col++)for(let row=1;row<=numRows;row++)addresses.push(createAddress(row,col));break;case GridDirection.RightUp:for(let row=numRows;row>=1;row--)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.LeftUp:for(let row=numRows;row>=1;row--)for(let col=numColumns;col>=1;col--)addresses.push(createAddress(row,col));break;default:throw new Error(`Unsupported direction: ${direction}`)}return addresses}const COLORS=["red","green","indigo","pink","blue","purple"];function backgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-500`)))}function disabledBackgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-200`)))}function mapify(items,key){return new Map(items.map((item=>[item[key],item])))}function regexSort(a,b,regExp){let aPrim,aSec,bPrim,bSec,alphaFirst=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],aAlpha=aPrim=a.replace(regExp.alpha,"");const bAlpha=bPrim=b.replace(regExp.alpha,""),aNumericVal=a.replace(regExp.numeric,""),bNumericVal=b.replace(regExp.numeric,""),aNumeric=aSec=""!==aNumericVal?parseInt(aNumericVal,10):Number.MAX_VALUE,bNumeric=bSec=""!==bNumericVal?parseInt(bNumericVal,10):Number.MAX_VALUE;return alphaFirst||(aPrim=aNumeric,bPrim=bNumeric,aSec=aAlpha,bSec=bAlpha),aPrim===bPrim?aSec===bSec?0:aSec>bSec?1:-1:aPrim>bPrim?1:-1}function isSameArray(array1,array2){return array1.length===array2.length&&array1.every((element=>array2.includes(element)))}Object.values(_types_sdk__WEBPACK_IMPORTED_MODULE_0__.JqL).map((val=>({value:val,label:val})))},"./src/types/sdk.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{IoU:()=>LabwareState,JqL:()=>SlideCosting,NN7:()=>LifeStage,W_V:()=>PassFail,ZpU:()=>FlagPriority,mDe:()=>ControlType,xMG:()=>getSdk});var graphql_request__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/graphql-request/build/esm/index.js");let LabwareState=function(LabwareState){return LabwareState.Empty="empty",LabwareState.Active="active",LabwareState.Discarded="discarded",LabwareState.Released="released",LabwareState.Destroyed="destroyed",LabwareState.Used="used",LabwareState}({}),PassFail=function(PassFail){return PassFail.Pass="pass",PassFail.Fail="fail",PassFail}({}),ControlType=function(ControlType){return ControlType.Positive="positive",ControlType.Negative="negative",ControlType}({}),LifeStage=function(LifeStage){return LifeStage.Adult="adult",LifeStage.Paediatric="paediatric",LifeStage.Fetal="fetal",LifeStage}({}),SlideCosting=function(SlideCosting){return SlideCosting.Faculty="Faculty",SlideCosting.Sgp="SGP",SlideCosting.WarrantyReplacement="Warranty_replacement",SlideCosting}({}),FlagPriority=function(FlagPriority){return FlagPriority.Note="note",FlagPriority.Flag="flag",FlagPriority}({});graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  selected
    ...
    `;const BioRiskFieldsFragmentDoc=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}
${HistoryEntryFieldsFragmentDoc}
${FlagBarcodesFieldsFragmentDoc}`,FindIfOpExistsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${FlagBarcodesFieldsFragmentDoc}`,FindLabwareLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  listFiles(workNumbers: $workNumbers) {
    ...
    ${FileFieldsFragmentDoc}`,FindMeasurementByBarcodeAndNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,FindReagentPlateDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  reagentPlate(barcode: $barcode) {
    ...
    ${ReagentSlotFieldsFragmentDoc}`,FindPermDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,FindPlanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,FindHistoryGraphDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  historyGraph(
    ...
    ${GraphSvgFieldsFragmentDoc}`,FindWorkNumbersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  comments(category: $commentCategory, includeDisabled: $includeDisabled) {
    ...
    ${CommentFieldsFragmentDoc}`,GetBioRisksDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetBioRisks($includeDisabled: Boolean) {
  bioRisks(includeDisabled: $includeDisabled) {
    ...BioRiskFields
  }
}
    ${BioRiskFieldsFragmentDoc}`,FindDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  destructionReasons(includeDisabled: $includeDisabled) {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,GetConfigurationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${ProteinPanelFieldsFragmentDoc}`,GetDnapStudyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetDnapStudy($ssId: Int!) {
  dnapStudy(ssId: $ssId) {
    ...DnapStudyFields
  }
}
    ${DnapStudyFieldsFragmentDoc}`,FindWorkInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(category: $category, includeDisabled: $includeDisabled) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetBlockProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetLabwareCostingDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  labwareBioRiskCodes(barcode: $barcode) {
    ...
    ${SampleBioRiskFieldsFragmentDoc}`,GetCleanedOutAddressesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  analyserScanData(barcode: $barcode) {
    ...
    ${AnalyserScanDataFieldsFragmentDoc}`,GetParaffinProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  nextReplicateNumbers(barcodes: $barcodes) {
    ...
    ${NextReplicateDataFieldsFragmentDoc}`,GetCellClassesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${UserFieldsFragmentDoc}`,GetDestroyInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetDestroyInfo {
  destructionReasons {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,GetOperationTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  labwareTypes {
    ...
    ${CommentFieldsFragmentDoc}
${LabwareTypeFieldsFragmentDoc}`,GetProteinPanelsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetProteinPanels($includeDisabled: Boolean) {
  proteinPanels(includeDisabled: $includeDisabled) {
    ...ProteinPanelFields
  }
}
    ${ProteinPanelFieldsFragmentDoc}`,GetProbePanelsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetRecordInPlaceInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(includeDisabled: false, category: $category) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetRunNamesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${ReleaseFileOptionFieldsFragmentDoc}`,GetSectioningConfirmInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  slotRegions(includeDisabled: false) {
    ...
    ${CommentFieldsFragmentDoc}
${SlotRegionFieldsFragmentDoc}`,GetSearchInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetSearchInfo {
  tissueTypes {
    name
  }
  ...
  stainReagentTypes {
    ...
    ${CommentFieldsFragmentDoc}`,GetStainInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetStainInfo {
  stainTypes {
    ...StainTypeFields
  }
...
${SampleFieldsFragmentDoc}`,GetSuggestedWorkForLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cellClasses {
    ...
    ${LabwareTypeFieldsFragmentDoc}`,GetWorkProgressInputsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}`,GetSuggestedLabwareForWorkDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CommentFieldsFragmentDoc}`,GetXeniumQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  runRois(barcode: $barcode, run: $run) {
    ...
    ${RoiFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,ReloadSlotCopyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addBioRisk(code: $code) {
    ...
    ${BioRiskFieldsFragmentDoc}`,AddFixativeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProgram(name: $name) {
    ...
    ${ProgramFieldsFragmentDoc}`,AddHmdmcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProbePanel(type: $type, name: $name) {
    ...
    ${ProbePanelFieldsFragmentDoc}`,AddReleaseRecipientDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddReleaseRecipient($username: String!, $fullName: String) {
  addReleaseRecipient(username: $username, fullName: $fullName) {
    ...ReleaseRecipientFields
  }
}
    ${ReleaseRecipientFieldsFragmentDoc}`,AddSpeciesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addSolution(name: $name) {
    ...
    ${SolutionFieldsFragmentDoc}`,AddWorkTypeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddWorkType($name: String!) {
  addWorkType(name: $name) {
    ...WorkTypeFields
  }
}
    ${WorkTypeFieldsFragmentDoc}`,AddSpatialLocationsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,AddTissueTypeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${PlanActionFieldsFragmentDoc}`,PerformTissuePotDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,RecordPermDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  registerAsEndUser(username: $username, password: $password) {
    ...
    ${UserFieldsFragmentDoc}`,RecordVisiumQcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,RecordRnaAnalysisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  saveSlotCopy(request: $request) {
    ...
    ${SlotCopyLoadFieldsFragmentDoc}`,RegisterSectionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,RecordStainResultDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setBioRiskEnabled(code: $code, enabled: $enabled) {
    ...
    ${BioRiskFieldsFragmentDoc}`,SetCellClassEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetCellClassEnabled($name: String!, $enabled: Boolean!) {
  setCellClassEnabled(name: $name, enabled: $enabled) {
    ...CellClassFields
  }
}
    ${CellClassFieldsFragmentDoc}`,SetCommentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetCommentEnabled($commentId: Int!, $enabled: Boolean!) {
  setCommentEnabled(commentId: $commentId, enabled: $enabled) {
    ...CommentFields
  }
}
    ${CommentFieldsFragmentDoc}`,RegisterTissuesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetCostCodeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setCostCodeEnabled(code: $code, enabled: $enabled) {
    ...
    ${CostCodeFieldsFragmentDoc}`,SetDestructionReasonEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetDestructionReasonEnabled($text: String!, $enabled: Boolean!) {
  setDestructionReasonEnabled(text: $text, enabled: $enabled) {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,SetFixativeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setHmdmcEnabled(hmdmc: $hmdmc, enabled: $enabled) {
    ...
    ${HmdmcFieldsFragmentDoc}`,SetEquipmentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetEquipmentEnabled($equipmentId: Int!, $enabled: Boolean!) {
  setEquipmentEnabled(equipmentId: $equipmentId, enabled: $enabled) {
    ...EquipmentFields
  }
}
    ${EquipmentFieldsFragmentDoc}`,SetLocationCustomNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,SetProbePanelEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProbePanelEnabled(type: $type, name: $name, enabled: $enabled) {
    ...
    ${ProbePanelFieldsFragmentDoc}`,RecordOrientationQcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  recordOrientationQC(request: $request) {
    ...
    `,SetOmeroProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProjectEnabled(name: $name, enabled: $enabled) {
    ...
    ${ProjectFieldsFragmentDoc}`,SetProgramEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetProgramEnabled($name: String!, $enabled: Boolean!) {
  setProgramEnabled(name: $name, enabled: $enabled) {
    ...ProgramFields
  }
}
    ${ProgramFieldsFragmentDoc}`,SetProteinPanelEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${UserFieldsFragmentDoc}`,SetReleaseRecipientEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setSolutionEnabled(name: $name, enabled: $enabled) {
    ...
    ${SolutionFieldsFragmentDoc}`,SetUserRoleDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetSpeciesEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setSpeciesEnabled(name: $name, enabled: $enabled) {
    ...
    ${SpeciesFieldsFragmentDoc}`,StainDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,SetWorkTypeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setWorkTypeEnabled(name: $name, enabled: $enabled) {
    ...
    ${WorkTypeFieldsFragmentDoc}`,TransferLocationItemsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,UpdateDnapStudiesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateDnapStudies {
    ...
    `,UnstoreBarcodeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  unstoreBarcode(barcode: $barcode) {
    ...
    `,UnreleaseDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,UpdateReleaseRecipientFullNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateReleaseRecipientFullName(username: $username, fullName: $fullName) {
    ...
    ${ReleaseRecipientFieldsFragmentDoc}`,UpdateWorkPriorityDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,AddProteinPanelDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddProteinPanel($name: String!) {
  addProteinPanel(name: $name) {
    ...ProteinPanelFields
  }
}
    ${ProteinPanelFieldsFragmentDoc}`,VisiumAnalysisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
