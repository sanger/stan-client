"use strict";(self.webpackChunkclient=self.webpackChunkclient||[]).push([[523],{"./src/lib/helpers.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{CI:()=>disabledBackgroundColorClassNames,EF:()=>backgroundColorClassNames,Kn:()=>LabwareDirection,Lb:()=>mapify,_f:()=>GridDirection,sn:()=>isSameArray,uv:()=>objectKeys,wz:()=>regexSort,x:()=>buildAddresses,yX:()=>Position});var _types_sdk__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/types/sdk.ts");__webpack_require__("./node_modules/lodash/lodash.js");function objectKeys(o){return Object.keys(o)}function*cycle(list){let i=0;const l=list.length;for(;;)yield list[i],i+=1,i===l&&(i=0)}let GridDirection=function(GridDirection){return GridDirection.RightDown="RightDown",GridDirection.DownRight="DownRight",GridDirection.RightUp="RightUp",GridDirection.UpRight="UpRight",GridDirection.LeftUp="LeftUp",GridDirection}({}),LabwareDirection=function(LabwareDirection){return LabwareDirection.Horizontal="Horizontal",LabwareDirection.Vertical="Vertical",LabwareDirection}({}),Position=function(Position){return Position.TopRight="TopRight",Position.BottomRight="BottomRight",Position.TopLeft="TopLeft",Position.BottomLeft="BottomLeft",Position.Right="Right",Position.Left="Left",Position}({});function createAddress(rowNumber,columnNumber){if(rowNumber>26)return`${rowNumber},${columnNumber}`;const aCharCode="A".charCodeAt(0);return`${String.fromCharCode(rowNumber+aCharCode-1)}${columnNumber}`}function buildAddresses(size){let direction=arguments.length>1&&void 0!==arguments[1]?arguments[1]:GridDirection.RightDown;const{numRows,numColumns}=size,addresses=new Array;switch(direction){case GridDirection.RightDown:for(let row=1;row<=numRows;row++)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.DownRight:for(let col=1;col<=numColumns;col++)for(let row=1;row<=numRows;row++)addresses.push(createAddress(row,col));break;case GridDirection.RightUp:for(let row=numRows;row>=1;row--)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.LeftUp:for(let row=numRows;row>=1;row--)for(let col=numColumns;col>=1;col--)addresses.push(createAddress(row,col));break;default:throw new Error(`Unsupported direction: ${direction}`)}return addresses}const COLORS=["red","green","indigo","pink","blue","purple"];function backgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-500`)))}function disabledBackgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-200`)))}function mapify(items,key){return new Map(items.map((item=>[item[key],item])))}function regexSort(a,b,regExp){let aPrim,aSec,bPrim,bSec,alphaFirst=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],aAlpha=aPrim=a.replace(regExp.alpha,"");const bAlpha=bPrim=b.replace(regExp.alpha,""),aNumericVal=a.replace(regExp.numeric,""),bNumericVal=b.replace(regExp.numeric,""),aNumeric=aSec=""!==aNumericVal?parseInt(aNumericVal,10):Number.MAX_VALUE,bNumeric=bSec=""!==bNumericVal?parseInt(bNumericVal,10):Number.MAX_VALUE;return alphaFirst||(aPrim=aNumeric,bPrim=bNumeric,aSec=aAlpha,bSec=bAlpha),aPrim===bPrim?aSec===bSec?0:aSec>bSec?1:-1:aPrim>bPrim?1:-1}function isSameArray(array1,array2){return array1.length===array2.length&&array1.every((element=>array2.includes(element)))}Object.values(_types_sdk__WEBPACK_IMPORTED_MODULE_0__.JqL).map((val=>({value:val,label:val})))},"./src/types/sdk.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{IoU:()=>LabwareState,JqL:()=>SlideCosting,NN7:()=>LifeStage,W_V:()=>PassFail,ZpU:()=>FlagPriority,mDe:()=>ControlType,xMG:()=>getSdk});var graphql_request__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/graphql-request/build/esm/index.js");let LabwareState=function(LabwareState){return LabwareState.Empty="empty",LabwareState.Active="active",LabwareState.Discarded="discarded",LabwareState.Released="released",LabwareState.Destroyed="destroyed",LabwareState.Used="used",LabwareState}({}),PassFail=function(PassFail){return PassFail.Pass="pass",PassFail.Fail="fail",PassFail}({}),ControlType=function(ControlType){return ControlType.Positive="positive",ControlType.Negative="negative",ControlType}({}),LifeStage=function(LifeStage){return LifeStage.Adult="adult",LifeStage.Paediatric="paediatric",LifeStage.Fetal="fetal",LifeStage}({}),SlideCosting=function(SlideCosting){return SlideCosting.Faculty="Faculty",SlideCosting.Sgp="SGP",SlideCosting.WarrantyReplacement="Warranty_replacement",SlideCosting}({}),FlagPriority=function(FlagPriority){return FlagPriority.Note="note",FlagPriority.Flag="flag",FlagPriority}({});const CommentFieldsFragmentDoc=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  user {
    ...
    ${UserFieldsFragmentDoc}`,FindHistoryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,ExtractResultDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,FindLocationByBarcodeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,FindReagentPlateDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  reagentPlate(barcode: $barcode) {
    ...
    ${ReagentSlotFieldsFragmentDoc}`,FindLabwareLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  samplePositions(labwareBarcode: $labwareBarcode) {
    ...
    ${SamplePositionFieldsFragmentDoc}`,FindHistoryGraphDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  historyGraph(
    ...
    ${GraphSvgFieldsFragmentDoc}`,FindLatestOperationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SamplePositionFieldsFragmentDoc}`,FindStoragePathDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  storagePath(locationBarcode: $locationBarcode) {
    ...
    ${LinkedLocationFieldsFragmentDoc}`,FindWorkNumbersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${PlanActionFieldsFragmentDoc}`,FindWorkInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkProgressTimeStampFieldFragmentDoc}`,FindWorksCreatedByDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,FindPassFailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotPassFailFieldsFragmentDoc}`,FindMeasurementByBarcodeAndNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  measurementValueFromLabwareOrParent(barcode: $barcode, name: $measurementName) {
    ...
    `,GetAllWorkInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetAnalyserScanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  comments(category: $commentCategory, includeDisabled: $includeDisabled) {
    ...
    ${CommentFieldsFragmentDoc}`,GetCleanedOutAddressesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  dnapStudy(ssId: $ssId) {
    ...
    ${DnapStudyFieldsFragmentDoc}`,GetDestroyInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetDestroyInfo {
  destructionReasons {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,GetParaffinProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(category: $category, includeDisabled: $includeDisabled) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetBioRisksDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cellClasses(includeDisabled: $includeDisabled) {
    ...
    ${CellClassFieldsFragmentDoc}`,GetOmeroProjectsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  nextReplicateNumbers(barcodes: $barcodes) {
    ...
    ${NextReplicateDataFieldsFragmentDoc}`,GetLabwareBioRiskCodesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetLabwareBioRiskCodes($barcode: String!) {
  labwareBioRiskCodes(barcode: $barcode) {
    ...SampleBioRiskFields
  }
}
    ${SampleBioRiskFieldsFragmentDoc}`,GetLabwareFlagDetailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CellClassFieldsFragmentDoc}`,GetLabwareOperationsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${UserFieldsFragmentDoc}`,GetPotProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  labwareTypes {
    ...
    ${CommentFieldsFragmentDoc}
${LabwareTypeFieldsFragmentDoc}`,GetProgramsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetPrograms {
  programs {
    name
    enabled
...
${SampleFieldsFragmentDoc}`,GetProbePanelsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  printers {
    ...
    ${PrinterFieldsFragmentDoc}`,GetRecordExtractResultInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetRecordExtractResultInfo {
  comments(category: "extract result", includeDisabled: false) {
    ...CommentFields
  }
}
    ${CommentFieldsFragmentDoc}`,GetReleaseColumnOptionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetRunNamesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(includeDisabled: false, category: $category) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetRunRoisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetOperationTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  stainTypes {
    ...
    ${StainTypeFieldsFragmentDoc}`,GetStainingQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${ReleaseFileOptionFieldsFragmentDoc}`,GetSectioningInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  stainReagentTypes {
    ...
    ${CommentFieldsFragmentDoc}`,GetSampleProcessingCommentsInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetSuggestedWorkForLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cellClasses {
    ...
    ${LabwareTypeFieldsFragmentDoc}`,GetWorkSummaryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}`,GetWorkAllocationInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CommentFieldsFragmentDoc}`,GetVisiumQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  workTypes(includeDisabled: true) {
    ...
    `,GetXeniumQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  reloadSlotCopy(
    ...
    ${SlotCopyLoadFieldsFragmentDoc}`,AddDestructionReasonDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddDestructionReason($text: String!) {
  addDestructionReason(text: $text) {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,GetSectioningConfirmInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  slotRegions(includeDisabled: false) {
    ...
    ${CommentFieldsFragmentDoc}
${SlotRegionFieldsFragmentDoc}`,AddEquipmentDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddEquipment($category: String!, $name: String!) {
  addEquipment(category: $category, name: $name) {
    ...EquipmentFields
  }
}
    ${EquipmentFieldsFragmentDoc}`,AddCostCodeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddCostCode($code: String!) {
  addCostCode(code: $code) {
    ...CostCodeFields
  }
}
    ${CostCodeFieldsFragmentDoc}`,AddCommentDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddComment($category: String!, $text: String!) {
  addComment(category: $category, text: $text) {
    ...CommentFields
  }
}
    ${CommentFieldsFragmentDoc}`,AddExternalIdDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addReleaseDestination(name: $name) {
    ...
    ${ReleaseDestinationFieldsFragmentDoc}`,AddOmeroProjectDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addSpecies(name: $name) {
    ...
    ${SpeciesFieldsFragmentDoc}`,AddReleaseRecipientDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddReleaseRecipient($username: String!, $fullName: String) {
  addReleaseRecipient(username: $username, fullName: $fullName) {
    ...ReleaseRecipientFields
  }
}
    ${ReleaseRecipientFieldsFragmentDoc}`,AddProgramDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddProgram($name: String!) {
  addProgram(name: $name) {
    ...ProgramFields
  }
}
    ${ProgramFieldsFragmentDoc}`,AddSpatialLocationsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addWorkType(name: $name) {
    ...
    ${WorkTypeFieldsFragmentDoc}`,AliquotDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,AddProbePanelDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddProbePanel($type: ProbeType!, $name: String!) {
  addProbePanel(type: $type, name: $name) {
    ...ProbePanelFields
  }
}
    ${ProbePanelFieldsFragmentDoc}`,AddBioRiskDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddBioRisk($code: String!) {
  addBioRisk(code: $code) {
    ...BioRiskFields
  }
}
    ${BioRiskFieldsFragmentDoc}`,ConfirmDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,AddUserDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddUser($username: String!) {
  addUser(username: $username) {
    ...UserFields
  }
}
    ${UserFieldsFragmentDoc}`,EmptyLocationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addSolution(name: $name) {
    ...
    ${SolutionFieldsFragmentDoc}`,DestroyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  destroy(request: $request) {
    ...
    `,ConfirmSectionDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,PerformTissueBlockDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${PlanActionFieldsFragmentDoc}`,RecordComplexStainDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,RegisterAsEndUserDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  registerAsEndUser(username: $username, password: $password) {
    ...
    ${UserFieldsFragmentDoc}`,SetCommentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetCommentEnabled($commentId: Int!, $enabled: Boolean!) {
  setCommentEnabled(commentId: $commentId, enabled: $enabled) {
    ...CommentFields
  }
}
    ${CommentFieldsFragmentDoc}`,RecordLibraryPrepDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetCostCodeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  saveSlotCopy(request: $request) {
    ...
    ${SlotCopyLoadFieldsFragmentDoc}`,SetDestructionReasonEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetDestructionReasonEnabled($text: String!, $enabled: Boolean!) {
  setDestructionReasonEnabled(text: $text, enabled: $enabled) {
    ...DestructionReasonFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}`,ReleaseLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  release(request: $releaseRequest) {
    ...
    `,SetCellClassEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,SetProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProjectEnabled(name: $name, enabled: $enabled) {
    ...
    ${ProjectFieldsFragmentDoc}`,SegmentationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetProgramEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setOmeroProjectEnabled(name: $name, enabled: $enabled) {
    ...
    ${OmeroProjectFieldsFragmentDoc}`,SetSlotRegionEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetSlotRegionEnabled($name: String!, $enabled: Boolean!) {
  setSlotRegionEnabled(name: $name, enabled: $enabled) {
    ...SlotRegionFields
  }
}
    ${SlotRegionFieldsFragmentDoc}`,SetReleaseDestinationEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetReleaseDestinationEnabled($name: String!, $enabled: Boolean!) {
  setReleaseDestinationEnabled(name: $name, enabled: $enabled) {
    ...ReleaseDestinationFields
  }
}
    ${ReleaseDestinationFieldsFragmentDoc}`,SetUserRoleDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetUserRole($username: String!, $role: UserRole!) {
  setUserRole(username: $username, role: $role) {
    ...UserFields
  }
}
    ${UserFieldsFragmentDoc}`,SetWorkTypeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetWorkTypeEnabled($name: String!, $enabled: Boolean!) {
  setWorkTypeEnabled(name: $name, enabled: $enabled) {
    ...WorkTypeFields
  }
}
    ${WorkTypeFieldsFragmentDoc}`,SetSpeciesEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetSpeciesEnabled($name: String!, $enabled: Boolean!) {
  setSpeciesEnabled(name: $name, enabled: $enabled) {
    ...SpeciesFields
  }
}
    ${SpeciesFieldsFragmentDoc}`,SetOpWorkRequestDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,StainDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  stain(request: $request) {
    ...
    `,TransferLocationItemsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  transfer(sourceBarcode: $sourceBarcode, destinationBarcode: $destinationBarcode) {
    ...
    ${LocationFieldsFragmentDoc}
${LinkedLocationFieldsFragmentDoc}`,SetSolutionEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,UnreleaseDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,UpdateReleaseRecipientFullNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateReleaseRecipientFullName(username: $username, fullName: $fullName) {
    ...
    ${ReleaseRecipientFieldsFragmentDoc}`,UpdateWorkNumBlocksDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
