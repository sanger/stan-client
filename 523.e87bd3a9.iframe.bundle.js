"use strict";(self.webpackChunkclient=self.webpackChunkclient||[]).push([[523],{"./src/lib/helpers.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{CI:()=>disabledBackgroundColorClassNames,EF:()=>backgroundColorClassNames,Kn:()=>LabwareDirection,Lb:()=>mapify,_f:()=>GridDirection,sn:()=>isSameArray,uv:()=>objectKeys,wz:()=>regexSort,x:()=>buildAddresses,yX:()=>Position});var _types_sdk__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/types/sdk.ts");__webpack_require__("./node_modules/lodash/lodash.js");function objectKeys(o){return Object.keys(o)}function*cycle(list){let i=0;const l=list.length;for(;;)yield list[i],i+=1,i===l&&(i=0)}let GridDirection=function(GridDirection){return GridDirection.RightDown="RightDown",GridDirection.DownRight="DownRight",GridDirection.RightUp="RightUp",GridDirection.UpRight="UpRight",GridDirection.LeftUp="LeftUp",GridDirection}({}),LabwareDirection=function(LabwareDirection){return LabwareDirection.Horizontal="Horizontal",LabwareDirection.Vertical="Vertical",LabwareDirection}({}),Position=function(Position){return Position.TopRight="TopRight",Position.BottomRight="BottomRight",Position.TopLeft="TopLeft",Position.BottomLeft="BottomLeft",Position.Right="Right",Position.Left="Left",Position}({});function createAddress(rowNumber,columnNumber){if(rowNumber>26)return`${rowNumber},${columnNumber}`;const aCharCode="A".charCodeAt(0);return`${String.fromCharCode(rowNumber+aCharCode-1)}${columnNumber}`}function buildAddresses(size){let direction=arguments.length>1&&void 0!==arguments[1]?arguments[1]:GridDirection.RightDown;const{numRows,numColumns}=size,addresses=new Array;switch(direction){case GridDirection.RightDown:for(let row=1;row<=numRows;row++)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.DownRight:for(let col=1;col<=numColumns;col++)for(let row=1;row<=numRows;row++)addresses.push(createAddress(row,col));break;case GridDirection.RightUp:for(let row=numRows;row>=1;row--)for(let col=1;col<=numColumns;col++)addresses.push(createAddress(row,col));break;case GridDirection.LeftUp:for(let row=numRows;row>=1;row--)for(let col=numColumns;col>=1;col--)addresses.push(createAddress(row,col));break;default:throw new Error(`Unsupported direction: ${direction}`)}return addresses}const COLORS=["red","green","indigo","pink","blue","purple"];function backgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-500`)))}function disabledBackgroundColorClassNames(){return cycle(COLORS.map((color=>`bg-${color}-200`)))}function mapify(items,key){return new Map(items.map((item=>[item[key],item])))}function regexSort(a,b,regExp){let aPrim,aSec,bPrim,bSec,alphaFirst=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],aAlpha=aPrim=a.replace(regExp.alpha,"");const bAlpha=bPrim=b.replace(regExp.alpha,""),aNumericVal=a.replace(regExp.numeric,""),bNumericVal=b.replace(regExp.numeric,""),aNumeric=aSec=""!==aNumericVal?parseInt(aNumericVal,10):Number.MAX_VALUE,bNumeric=bSec=""!==bNumericVal?parseInt(bNumericVal,10):Number.MAX_VALUE;return alphaFirst||(aPrim=aNumeric,bPrim=bNumeric,aSec=aAlpha,bSec=bAlpha),aPrim===bPrim?aSec===bSec?0:aSec>bSec?1:-1:aPrim>bPrim?1:-1}function isSameArray(array1,array2){return array1.length===array2.length&&array1.every((element=>array2.includes(element)))}Object.values(_types_sdk__WEBPACK_IMPORTED_MODULE_0__.JqL).map((val=>({value:val,label:val})))},"./src/types/sdk.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{IoU:()=>LabwareState,JqL:()=>SlideCosting,NN7:()=>LifeStage,W_V:()=>PassFail,ZpU:()=>FlagPriority,mDe:()=>ControlType,xMG:()=>getSdk});var graphql_request__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/graphql-request/build/esm/index.js");let LabwareState=function(LabwareState){return LabwareState.Empty="empty",LabwareState.Active="active",LabwareState.Discarded="discarded",LabwareState.Released="released",LabwareState.Destroyed="destroyed",LabwareState.Used="used",LabwareState}({}),PassFail=function(PassFail){return PassFail.Pass="pass",PassFail.Fail="fail",PassFail}({}),ControlType=function(ControlType){return ControlType.Positive="positive",ControlType.Negative="negative",ControlType}({}),LifeStage=function(LifeStage){return LifeStage.Adult="adult",LifeStage.Paediatric="paediatric",LifeStage.Fetal="fetal",LifeStage}({}),SlideCosting=function(SlideCosting){return SlideCosting.Faculty="Faculty",SlideCosting.Sgp="SGP",SlideCosting.WarrantyReplacement="Warranty_replacement",SlideCosting}({}),FlagPriority=function(FlagPriority){return FlagPriority.Note="note",FlagPriority.Flag="flag",FlagPriority}({});graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  selected
    ...
    `;const AnalyserScanDataFieldsFragmentDoc=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,FindPassFailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotPassFailFieldsFragmentDoc}`,FindLatestOperationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${PlanActionFieldsFragmentDoc}`,FindReagentPlateDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  reagentPlate(barcode: $barcode) {
    ...
    ${ReagentSlotFieldsFragmentDoc}`,FindWorksCreatedByDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,FindStoragePathDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query FindStoragePath($locationBarcode: String!) {
  storagePath(locationBarcode: $locationBarcode) {
    ...LinkedLocationFields
  }
}
    ${LinkedLocationFieldsFragmentDoc}`,GetAllWorkInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  works {
    ...
    `,FindHistoryForWorkNumberDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}
${HistoryEntryFieldsFragmentDoc}
${FlagBarcodesFieldsFragmentDoc}`,FindWorkNumbersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  comments(category: $commentCategory, includeDisabled: $includeDisabled) {
    ...
    ${CommentFieldsFragmentDoc}`,GetBlockProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetDestroyInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  destructionReasons {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,GetAnalyserScanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetAnalyserScanData($barcode: String!) {
  analyserScanData(barcode: $barcode) {
    ...AnalyserScanDataFields
  }
}
    ${AnalyserScanDataFieldsFragmentDoc}`,GetDestructionReasonsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cleanedOutAddresses(barcode: $barcode)
    ...
    `,GetBioRisksDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetBioRisks($includeDisabled: Boolean) {
  bioRisks(includeDisabled: $includeDisabled) {
    ...BioRiskFields
  }
}
    ${BioRiskFieldsFragmentDoc}`,GetDnapStudyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${UserFieldsFragmentDoc}`,GetLabwareFlagDetailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  labwareTypes {
    ...
    ${CommentFieldsFragmentDoc}
${LabwareTypeFieldsFragmentDoc}`,GetEquipmentsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  probePanels(type: $type) {
    ...
    `,GetProbeHybSlotsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  equipments(includeDisabled: false, category: $category) {
    ...
    ${EquipmentFieldsFragmentDoc}`,GetOperationTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  printers {
    ...
    ${PrinterFieldsFragmentDoc}`,GetReleaseInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetRunNamesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  cellClasses {
    ...
    ${LabwareTypeFieldsFragmentDoc}`,GetSampleProcessingCommentsInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  species {
    ...
    `,GetSectioningInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  stainTypes {
    ...
    ${StainTypeFieldsFragmentDoc}`,GetSectioningConfirmInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  slotRegions(includeDisabled: false) {
    ...
    ${CommentFieldsFragmentDoc}
${SlotRegionFieldsFragmentDoc}`,GetSuggestedLabwareForWorkDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,GetStainingQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetStainingQCInfo {
  comments(includeDisabled: false, category: "stain QC") {
    ...CommentFields
  }
}
    ${CommentFieldsFragmentDoc}`,GetSlotRegionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetSolutionTransferInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  suggestedWorkForLabware(barcodes: $barcodes, includeInactive: $includeInactive) {
    ...
    ${SuggestedWorkFieldsFragmentDoc}`,GetVisiumQcInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CommentFieldsFragmentDoc}`,ReloadSlotCopyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  reloadSlotCopy(
    ...
    ${SlotCopyLoadFieldsFragmentDoc}`,GetWorkProgressInputsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addCostCode(code: $code) {
    ...
    ${CostCodeFieldsFragmentDoc}`,AddHmdmcDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProbePanel(type: $type, name: $name) {
    ...
    ${ProbePanelFieldsFragmentDoc}`,AddOmeroProjectDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProgram(name: $name) {
    ...
    ${ProgramFieldsFragmentDoc}`,AddReleaseDestinationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddReleaseDestination($name: String!) {
  addReleaseDestination(name: $name) {
    ...ReleaseDestinationFields
  }
}
    ${ReleaseDestinationFieldsFragmentDoc}`,AddSlotRegionDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddSlotRegion($name: String!) {
  addSlotRegion(name: $name) {
    ...SlotRegionFields
  }
}
    ${SlotRegionFieldsFragmentDoc}`,AddSolutionDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddSolution($name: String!) {
  addSolution(name: $name) {
    ...SolutionFields
  }
}
    ${SolutionFieldsFragmentDoc}`,GetWorkSummaryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}`,AddSpeciesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addUser(username: $username) {
    ...
    ${UserFieldsFragmentDoc}`,AddSpatialLocationsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CellClassFieldsFragmentDoc}`,AddReleaseRecipientDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation AddReleaseRecipient($username: String!, $fullName: String) {
  addReleaseRecipient(username: $username, fullName: $fullName) {
    ...ReleaseRecipientFields
  }
}
    ${ReleaseRecipientFieldsFragmentDoc}`,ConfirmSectionDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,PerformTissuePotDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,ReleaseLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setCellClassEnabled(name: $name, enabled: $enabled) {
    ...
    ${CellClassFieldsFragmentDoc}`,SetCostCodeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setFixativeEnabled(name: $name, enabled: $enabled) {
    ...
    ${FixativeFieldsFragmentDoc}`,SetProgramEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProbePanelEnabled(type: $type, name: $name, enabled: $enabled) {
    ...
    ${ProbePanelFieldsFragmentDoc}`,SetReleaseDestinationEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetReleaseDestinationEnabled($name: String!, $enabled: Boolean!) {
  setReleaseDestinationEnabled(name: $name, enabled: $enabled) {
    ...ReleaseDestinationFields
  }
}
    ${ReleaseDestinationFieldsFragmentDoc}`,SetLocationCustomNameDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setLocationCustomName(
    ...
    ${LocationFieldsFragmentDoc}
${LinkedLocationFieldsFragmentDoc}`,SegmentationDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,SetOpWorkRequestDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${UserFieldsFragmentDoc}`,SetReleaseRecipientEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setReleaseRecipientEnabled(username: $username, enabled: $enabled) {
    ...
    ${ReleaseRecipientFieldsFragmentDoc}`,SetOmeroProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setSpeciesEnabled(name: $name, enabled: $enabled) {
    ...
    ${SpeciesFieldsFragmentDoc}`,SetUserRoleDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetUserRole($username: String!, $role: UserRole!) {
  setUserRole(username: $username, role: $role) {
    ...UserFields
  }
}
    ${UserFieldsFragmentDoc}`,SetSlotRegionEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,StoreBarcodeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,StainDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  store(store: $store, locationBarcode: $locationBarcode) {
    ...
    ${LocationFieldsFragmentDoc}
${LinkedLocationFieldsFragmentDoc}`,SetWorkTypeEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,UpdateDnapStudiesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateDnapStudies {
    ...
    `,VisiumAnalysisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
