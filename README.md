...
In order for `graphql-codegen` to generate TypeScript types to match the GraphQL schema, create a `.env` file in the root of the project and include the property `GRAPHQL_SCHEMA_LOCATION`:
