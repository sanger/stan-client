"use strict";(self.webpackChunkclient=self.webpackChunkclient||[]).push([[523],{"./src/lib/helpers.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Lb:()=>mapify,sn:()=>isSameArray,tQ:()=>cycleColors,uv:()=>objectKeys,wz:()=>regexSort,x:()=>buildAddresses});var _types_sdk__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/types/sdk.ts");__webpack_require__("./node_modules/lodash/lodash.js");function objectKeys(o){return Object.keys(o)}function createAddress(rowNumber,columnNumber){if(rowNumber>26)return`${rowNumber},${columnNumber}`;const aCharCode="A".charCodeAt(0);return`${String.fromCharCode(rowNumber+aCharCode-1)}${columnNumber}`}function buildAddresses(size){let direction=arguments.length>1&&void 0!==arguments[1]?arguments[1]:_types_sdk__WEBPACK_IMPORTED_MODULE_0__._fI.RightDown,directionSize=direction===_types_sdk__WEBPACK_IMPORTED_MODULE_0__._fI.RightDown?size.numRows:size.numColumns,orthogonalDirectionSize=direction===_types_sdk__WEBPACK_IMPORTED_MODULE_0__._fI.RightDown?size.numColumns:size.numRows;const addresses=new Array;for(let i=1,j=directionSize;i<=j;i++)for(let m=1,n=orthogonalDirectionSize;m<=n;m++)direction===_types_sdk__WEBPACK_IMPORTED_MODULE_0__._fI.RightDown?addresses.push(createAddress(i,m)):addresses.push(createAddress(m,i));return addresses}function cycleColors(){return function*cycle(list){let i=0;const l=list.length;for(;;)yield list[i],i+=1,i===l&&(i=0)}(["red","green","indigo","pink","blue","purple"])}function mapify(items,key){return new Map(items.map((item=>[item[key],item])))}function regexSort(a,b,regExp){let aPrim,aSec,bPrim,bSec,alphaFirst=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],aAlpha=aPrim=a.replace(regExp.alpha,"");const bAlpha=bPrim=b.replace(regExp.alpha,""),aNumericVal=a.replace(regExp.numeric,""),bNumericVal=b.replace(regExp.numeric,""),aNumeric=aSec=""!==aNumericVal?parseInt(aNumericVal,10):Number.MAX_VALUE,bNumeric=bSec=""!==bNumericVal?parseInt(bNumericVal,10):Number.MAX_VALUE;return alphaFirst||(aPrim=aNumeric,bPrim=bNumeric,aSec=aAlpha,bSec=bAlpha),aPrim===bPrim?aSec===bSec?0:aSec>bSec?1:-1:aPrim>bPrim?1:-1}function isSameArray(array1,array2){return array1.length===array2.length&&array1.every((element=>array2.includes(element)))}},"./src/types/sdk.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{IoU:()=>LabwareState,NN7:()=>LifeStage,W_V:()=>PassFail,_fI:()=>GridDirection,mDe:()=>ControlType,xMG:()=>getSdk});var graphql_request__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/graphql-request/build/esm/index.js");let LabwareState=function(LabwareState){return LabwareState.Empty="empty",LabwareState.Active="active",LabwareState.Discarded="discarded",LabwareState.Released="released",LabwareState.Destroyed="destroyed",LabwareState.Used="used",LabwareState}({}),PassFail=function(PassFail){return PassFail.Pass="pass",PassFail.Fail="fail",PassFail}({}),ControlType=function(ControlType){return ControlType.Positive="positive",ControlType.Negative="negative",ControlType}({}),LifeStage=function(LifeStage){return LifeStage.Adult="adult",LifeStage.Paediatric="paediatric",LifeStage.Fetal="fetal",LifeStage}({}),GridDirection=function(GridDirection){return GridDirection.RightDown="RightDown",GridDirection.DownRight="DownRight",GridDirection.RightUp="RightUp",GridDirection.UpRight="UpRight",GridDirection}({});graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${HistoryEntryFieldsFragmentDoc}`,FindFlaggedLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${HistoryEntryFieldsFragmentDoc}`,FindHistoryForSampleIdDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}
${PlanActionFieldsFragmentDoc}`,FindWorkProgressDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetAnalyserScanDataDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  bioRisks(includeDisabled: $includeDisabled) {
    ...
    ${BioRiskFieldsFragmentDoc}`,GetDestroyInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,GetEventTypesDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    query GetEventTypes {
  eventTypes
}
...
${UserFieldsFragmentDoc}`,GetOmeroProjectsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  nextReplicateNumbers(barcodes: $barcodes) {
    ...
    ${NextReplicateDataFieldsFragmentDoc}`,GetLabwareFlagDetailsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}`,GetPrintersDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  printers {
    ...
    ${PrinterFieldsFragmentDoc}`,GetParaffinProcessingInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${ReleaseFileOptionFieldsFragmentDoc}`,GetReleaseColumnOptionsDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  slotRegions(includeDisabled: false) {
    ...
    ${CommentFieldsFragmentDoc}
${SlotRegionFieldsFragmentDoc}`,GetRunRoisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,GetSearchInfoDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  stainTypes {
    ...
    ${StainTypeFieldsFragmentDoc}`,GetSuggestedLabwareForWorkDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${WorkTypeFieldsFragmentDoc}
${OmeroProjectFieldsFragmentDoc}
${DnapStudyFieldsFragmentDoc}`,GetWorkSummaryDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${CommentFieldsFragmentDoc}`,AddCommentDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addBioRisk(code: $code) {
    ...
    ${BioRiskFieldsFragmentDoc}`,AddCostCodeDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addDestructionReason(text: $text) {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,AddProjectDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addProgram(name: $name) {
    ...
    ${ProgramFieldsFragmentDoc}`,AddSlotRegionDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  addReleaseDestination(name: $name) {
    ...
    ${ReleaseDestinationFieldsFragmentDoc}`,AddExternalIdDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${SampleFieldsFragmentDoc}`,SetCommentEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setCommentEnabled(commentId: $commentId, enabled: $enabled) {
    ...
    ${CommentFieldsFragmentDoc}`,ReleaseLabwareDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LabwareTypeFieldsFragmentDoc}
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`,SetHmdmcEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setEquipmentEnabled(equipmentId: $equipmentId, enabled: $enabled) {
    ...
    ${EquipmentFieldsFragmentDoc}`,SetBioRiskEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${LinkedLocationFieldsFragmentDoc}`,SetOmeroProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setDestructionReasonEnabled(text: $text, enabled: $enabled) {
    ...
    ${DestructionReasonFieldsFragmentDoc}`,SetProjectEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setProbePanelEnabled(name: $name, enabled: $enabled) {
    ...
    ${ProbePanelFieldsFragmentDoc}`,SetProgramEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
    mutation SetProgramEnabled($name: String!, $enabled: Boolean!) {
  setProgramEnabled(name: $name, enabled: $enabled) {
    ...ProgramFields
  }
}
    ${ProgramFieldsFragmentDoc}`,SetReleaseDestinationEnabledDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  setWorkTypeEnabled(name: $name, enabled: $enabled) {
    ...
    ${WorkTypeFieldsFragmentDoc}`,SlotCopyDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
...
${DnapStudyFieldsFragmentDoc}`,VisiumAnalysisDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
  ...
  updateReleaseRecipientFullName(username: $username, fullName: $fullName) {
    ...
    ${ReleaseRecipientFieldsFragmentDoc}`,CleanOutDocument=graphql_request__WEBPACK_IMPORTED_MODULE_0__.J1`
