...
export type CancelPlanAction = {
  ...
  newSection?: InputMaybe<Scalars['String']['input']>;
...
export type ConfirmSection = {
  ...
  /** The addresses of the destination slots for the section. */
  destinationAddresses: Array<Scalars['Address']['input']>;
...
export type Mutation = {
  ...
  addProject: Project;
  /** Add a new protein panel. */
  addProteinPanel: ProteinPanel;
  ...
  /** Enable or disable a protein panel. */
  setProteinPanelEnabled: ProteinPanel;
 ...
 * These typically require a user with the suitable permission for the particular request.
 */
export type MutationAddProteinPanelArgs = {
  name: Scalars['String']['input'];
};
 ...
 * These typically require a user with the suitable permission for the particular request.
 */
export type MutationSetProteinPanelEnabledArgs = {
  enabled: Scalars['Boolean']['input'];
  name: Scalars['String']['input'];
};
 ...
 * These typically require a user with the suitable permission for the particular request.
 */
export type MutationUpdateWorkXeniumStudyArgs = {
  ssStudyId?: InputMaybe<Scalars['Int']['input']>;
  workNumber: Scalars['String']['input'];
};
...
/** Panel, lot number, costing. */
export type PanelLot = {
  /** Costing. */
...
export type PlanAction = {
  ...
  newSection?: Maybe<Scalars['String']['output']>;
...
export type PlanData = {
  ...
  /** The groups of addresses specified by the plan. */
  groups: Array<Array<Scalars['Address']['output']>>;
...
export type PlanRequestAction = {
  /** The intended addresses of the sample in the destination labware. */
  addresses: Array<Scalars['Address']['input']>;
...
export type Query = {
   ...
   */
  opExists: Scalars['Boolean']['output'];
  /** Operation types. */
  ...
  probeHybSlots: Array<Scalars['Address']['output']>;
  ...
  /** Get protein panels that are enabled, or all including disabled. */
  proteinPanels: Array<ProteinPanel>;
 ...
 * These typically require no user privilege.
 */
export type QueryProbeHybSlotsArgs = {
  barcode: Scalars['String']['input'];
};
 ...
 * These typically require no user privilege.
 */
export type QueryProteinPanelsArgs = {
  includeDisabled?: InputMaybe<Scalars['Boolean']['input']>;
};
 ...
 * These typically require no user privilege.
 */
export type QueryReleaseColumnOptionsArgs = {
  includeDisabled?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type Sample = {
  ...
  id: Scalars['Int']['output'];
  /** An optional string describing the particular slice through the block of tissue that this sample came from. */
...
export type SectionRegisterLabware = {
  ...
  /** The name of the type of labware. */
  labwareType: Scalars['String']['input'];
  /** The lot number of the labware, if any. */
...
export type SegmentationLabware = {
  ...
  performed?: InputMaybe<Scalars['Timestamp']['input']>;
  /** Protein panels and lot numbers. */
  proteinPanels?: InputMaybe<Array<PanelLot>>;
...
export type SlotCopyDestination = {
  ...
  /** Reagent A lot number, if specified. */
  reagentALot?: InputMaybe<Scalars['String']['input']>;
  /** Reagent B lot number, if specified. */
  reagentBLot?: InputMaybe<Scalars['String']['input']>;
  /** Costing for reagent, if specified. */
  reagentCosting?: InputMaybe<SlideCosting>;
  /** Single reagent lot, if specified. */
  reagentLot?: InputMaybe<Scalars['String']['input']>;
};
...
export type SlotCopyLoad = {
  ...
  /** Reagent A lot number, if specified. */
  reagentALot?: Maybe<Scalars['String']['output']>;
  /** Reagent B lot number, if specified. */
  reagentBLot?: Maybe<Scalars['String']['output']>;
...
/** Info describing a new block in a tissue block request. */
export type TissueBlockContent = {
  /** The addresses to place the sample in the new labware. */
  addresses: Array<Scalars['Address']['input']>;
  /** The id of a comment to record on the new block, if any. */
  commentId?: InputMaybe<Scalars['Int']['input']>;
  /** The replicate number for the new block. */
  replicate?: InputMaybe<Scalars['String']['input']>;
  /** The barcode of the labware containing the source sample. */
  sourceBarcode: Scalars['String']['input'];
  /** The id of the source sample. */
  sourceSampleId: Scalars['Int']['input'];
};

/** The input about a new block being created. */
export type TissueBlockLabware = {
  /** The contents (new samples) for the new labware. */
  contents: Array<TissueBlockContent>;
  /** The labware type for the new labware. */
  labwareType: Scalars['String']['input'];
  /** The number of columns required in the labware, if overridden. */
  numColumns?: InputMaybe<Scalars['Int']['input']>;
  /** The number of rows required in the labware, if overridden. */
...
export type Work = {
  ...
  dnapStudy?: Maybe<DnapStudy>;
  /** The faculty lead for this work, if any. */
  facultyLead?: Maybe<ReleaseDestination>;
  /**
...
export type HistoryFieldsFragment = { __typename?: 'History', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }>, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }>, entries: Array<{ __typename?: 'HistoryEntry', destinationLabwareId: number, details: Array<string>, eventId: number, sampleId?: number | null, sourceLabwareId: number, time: string, username: string, type: string, workNumber?: string | null, address?: string | null, region?: string | null }>, flagBarcodes: Array<{ __typename?: 'FlagBarcodes', barcodes: Array<string>, priority: FlagPriority }> };

export type HmdmcFieldsFragment = { __typename?: 'Hmdmc', hmdmc: string, enabled: boolean };

export type LabwareFieldsFragment = { __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> };

export type LabwareFlaggedFieldsFragment = { __typename?: 'LabwareFlagged', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, flagged: boolean, flagPriority?: FlagPriority | null, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> };

export type LabwareRoiFieldsFragment = { __typename?: 'LabwareRoi', barcode: string, rois: Array<{ __typename?: 'Roi', address: string, roi: string, sample: { __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } } }> };
...
export type RoiFieldsFragment = { __typename?: 'Roi', address: string, roi: string, sample: { __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } } };

export type SampleBioRiskFieldsFragment = { __typename?: 'SampleBioRisk', sampleId: number, bioRiskCode: string };

export type SampleFieldsFragment = { __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } };
...
export type SlotFieldsFragment = { __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> };
...
export type TreatmentTypeFieldsFragment = { __typename?: 'TreatmentType', name: string, enabled: boolean };
...
export type AddProteinPanelMutationVariables = Exact<{
  name: Scalars['String']['input'];
}>;


export type AddProteinPanelMutation = { __typename?: 'Mutation', addProteinPanel: { __typename?: 'ProteinPanel', name: string, enabled: boolean } };
...
export type AddTreatmentTypeMutationVariables = Exact<{
  name: Scalars['String']['input'];
}>;


export type AddTreatmentTypeMutation = { __typename?: 'Mutation', addTreatmentType: { __typename?: 'TreatmentType', name: string, enabled: boolean } };
...
export type ConfirmMutation = { __typename?: 'Mutation', confirmOperation: { __typename?: 'ConfirmOperationResult', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }>, operations: Array<{ __typename?: 'Operation', performed: string, operationType: { __typename?: 'OperationType', name: string }, user: { __typename?: 'User', username: string } }> } };
...
export type PlanMutation = { __typename?: 'Mutation', plan: { __typename?: 'PlanResult', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }>, operations: Array<{ __typename?: 'PlanOperation', operationType?: { __typename?: 'OperationType', name: string } | null, planActions: Array<{ __typename?: 'PlanAction', newSection?: string | null, sampleThickness?: string | null, sample: { __typename?: 'Sample', id: number }, source: { __typename?: 'Slot', address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number }> }, destination: { __typename?: 'Slot', address: string, labwareId: number } }> }> } };
...
export type RecordLibraryPrepMutation = { __typename?: 'Mutation', libraryPrep: { __typename?: 'OperationResult', operations: Array<{ __typename?: 'Operation', id: number }>, labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }> } };
...
export type RegisterOriginalSamplesMutation = { __typename?: 'Mutation', registerOriginalSamples: { __typename?: 'RegisterResult', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }>, clashes: Array<{ __typename?: 'RegisterClash', tissue: { __typename?: 'Tissue', externalName?: string | null, donor: { __typename?: 'Donor', donorName: string }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } } }, labware: Array<{ __typename?: 'Labware', barcode: string, labwareType: { __typename?: 'LabwareType', name: string } }> }>, labwareSolutions: Array<{ __typename?: 'LabwareSolutionName', barcode: string, solutionName: string } | null> } };
...
export type RegisterSectionsMutation = { __typename?: 'Mutation', registerSections: { __typename?: 'RegisterResult', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }> } };
...
export type RegisterTissuesMutation = { __typename?: 'Mutation', registerBlocks: { __typename?: 'RegisterResult', labware: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }>, clashes: Array<{ __typename?: 'RegisterClash', tissue: { __typename?: 'Tissue', externalName?: string | null, donor: { __typename?: 'Donor', donorName: string }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } } }, labware: Array<{ __typename?: 'Labware', barcode: string, labwareType: { __typename?: 'LabwareType', name: string } }> }>, labwareSolutions: Array<{ __typename?: 'LabwareSolutionName', barcode: string, solutionName: string } | null> } };
...
export type SetProteinPanelEnabledMutationVariables = Exact<{
  name: Scalars['String']['input'];
  enabled: Scalars['Boolean']['input'];
}>;


export type SetProteinPanelEnabledMutation = { __typename?: 'Mutation', setProteinPanelEnabled: { __typename?: 'ProteinPanel', name: string, enabled: boolean } };
...
export type SetTreatmentTypeEnabledMutationVariables = Exact<{
  name: Scalars['String']['input'];
  enabled: Scalars['Boolean']['input'];
}>;


export type SetTreatmentTypeEnabledMutation = { __typename?: 'Mutation', setTreatmentTypeEnabled: { __typename?: 'TreatmentType', name: string, enabled: boolean } };
...
export type FindIfOpExistsQueryVariables = Exact<{
  operationType: Scalars['String']['input'];
  barcode: Scalars['String']['input'];
  run?: InputMaybe<Scalars['String']['input']>;
  workNumber?: InputMaybe<Scalars['String']['input']>;
...
export type FindIfOpExistsQuery = { __typename?: 'Query', opExists: boolean };
...
export type FindLabwareQuery = { __typename?: 'Query', labware: { __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> } };
...
export type GetLabwareInLocationQuery = { __typename?: 'Query', labwareInLocation: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }> };
...
export type GetProbeHybSlotsQueryVariables = Exact<{
  barcode: Scalars['String']['input'];
}>;


export type GetProbeHybSlotsQuery = { __typename?: 'Query', probeHybSlots: Array<string> };
...
export type GetProteinPanelsQueryVariables = Exact<{
  includeDisabled?: InputMaybe<Scalars['Boolean']['input']>;
}>;


export type GetProteinPanelsQuery = { __typename?: 'Query', proteinPanels: Array<{ __typename?: 'ProteinPanel', name: string, enabled: boolean }> };
...
export type GetReleaseColumnOptionsQueryVariables = Exact<{
  includeDisabled?: InputMaybe<Scalars['Boolean']['input']>;
}>;
...
export type GetSectioningCommentsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSectioningCommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', id: number, text: string, category: string, enabled: boolean }> };
...
export type GetSuggestedLabwareForWorkQuery = { __typename?: 'Query', suggestedLabwareForWork: Array<{ __typename?: 'Labware', id: number, barcode: string, externalBarcode?: string | null, destroyed: boolean, discarded: boolean, released: boolean, state: LabwareState, created: string, numRows: number, numColumns: number, labwareType: { __typename?: 'LabwareType', name: string, numRows: number, numColumns: number, labelType?: { __typename?: 'LabelType', name: string } | null }, slots: Array<{ __typename?: 'Slot', id: number, address: string, labwareId: number, samples: Array<{ __typename?: 'Sample', id: number, section?: string | null, blockHighestSection?: number | null, tissue: { __typename?: 'Tissue', externalName?: string | null, replicate?: string | null, collectionDate?: string | null, donor: { __typename?: 'Donor', donorName: string, lifeStage?: LifeStage | null }, spatialLocation: { __typename?: 'SpatialLocation', code: number, name: string, tissueType: { __typename?: 'TissueType', name: string } }, hmdmc?: { __typename?: 'Hmdmc', hmdmc: string } | null, medium: { __typename?: 'Medium', name: string }, fixative: { __typename?: 'Fixative', name: string, enabled: boolean } }, bioState: { __typename?: 'BioState', name: string } }> }> }> };
...
export const ProbePanelFieldsFragmentDoc = gql`
  ...
  type
    ...
    `;
export const ProteinPanelFieldsFragmentDoc = gql`
...
export const ReleaseDestinationFieldsFragmentDoc = gql`
  ...
  enabled
    ...
    `;
export const TreatmentTypeFieldsFragmentDoc = gql`
    fragment TreatmentTypeFields on TreatmentType {
  name
  enabled
}
    `;
...
export const AddProteinPanelDocument = gql`
    mutation AddProteinPanel($name: String!) {
  addProteinPanel(name: $name) {
    ...ProteinPanelFields
  }
}
    ${ProteinPanelFieldsFragmentDoc}`;
...
export const AddTissueTypeDocument = gql`
  ...
  addTissueType(request: $request) {
    ...
    `;
export const AddTreatmentTypeDocument = gql`
...
export const SetProjectEnabledDocument = gql`
  ...
  setProjectEnabled(name: $name, enabled: $enabled) {
    ...
    ${ProjectFieldsFragmentDoc}`;
export const SetProteinPanelEnabledDocument = gql`
...
export const SetSpeciesEnabledDocument = gql`
  ...
  setSpeciesEnabled(name: $name, enabled: $enabled) {
    ...
    ${SpeciesFieldsFragmentDoc}`;
export const SetTreatmentTypeEnabledDocument = gql`
    mutation SetTreatmentTypeEnabled($name: String!, $enabled: Boolean!) {
  setTreatmentTypeEnabled(name: $name, enabled: $enabled) {
    ...TreatmentTypeFields
  }
}
    ${TreatmentTypeFieldsFragmentDoc}`;
...
${ReleaseDestinationFieldsFragmentDoc}
${TreatmentTypeFieldsFragmentDoc}`;
export const UpdateWorkTreatmentTypesDocument = gql`
    mutation UpdateWorkTreatmentTypes($workNumber: String!, $treatmentTypes: [String!]!) {
  updateWorkTreatmentTypes(
    workNumber: $workNumber
    treatmentTypes: $treatmentTypes
  ) {
...
${ReleaseDestinationFieldsFragmentDoc}
${TreatmentTypeFieldsFragmentDoc}`;
export const UpdateWorkXeniumStudyDocument = gql`
    mutation UpdateWorkXeniumStudy($workNumber: String!, $ssStudyId: Int) {
  updateWorkXeniumStudy(workNumber: $workNumber, ssStudyId: $ssStudyId) {
    ...WorkFields
  }
}
    ${WorkFieldsFragmentDoc}
...
export const FindIfOpExistsDocument = gql`
...
export const GetConfigurationDocument = gql`
  ...
  treatmentTypes(includeDisabled: true) {
    ...TreatmentTypeFields
  }
}
    ${DestructionReasonFieldsFragmentDoc}
...
export const GetProbeHybSlotsDocument = gql`
...
export const GetProgramsDocument = gql`
  ...
  programs {
    ...
    `;
export const GetProteinPanelsDocument = gql`
...
export const GetSearchInfoDocument = gql`
  ...
  species {
    ...
    `;
export const GetSectioningCommentsDocument = gql`
    query GetSectioningComments {
...
export const GetWorkAllocationInfoDocument = gql`
  ...
  treatmentTypes(includeDisabled: false) {
    ...TreatmentTypeFields
  }
}
    ${ProjectFieldsFragmentDoc}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    AddProteinPanel(variables: AddProteinPanelMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AddProteinPanelMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddProteinPanelMutation>(AddProteinPanelDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AddProteinPanel', 'mutation', variables);
    },
    ...
    AddTreatmentType(variables: AddTreatmentTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AddTreatmentTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddTreatmentTypeMutation>(AddTreatmentTypeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AddTreatmentType', 'mutation', variables);
    },
    ...
    SetProteinPanelEnabled(variables: SetProteinPanelEnabledMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SetProteinPanelEnabledMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetProteinPanelEnabledMutation>(SetProteinPanelEnabledDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SetProteinPanelEnabled', 'mutation', variables);
    },
    ...
    SetTreatmentTypeEnabled(variables: SetTreatmentTypeEnabledMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SetTreatmentTypeEnabledMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetTreatmentTypeEnabledMutation>(SetTreatmentTypeEnabledDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SetTreatmentTypeEnabled', 'mutation', variables);
    },
    ...
    FindIfOpExists(variables: FindIfOpExistsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<FindIfOpExistsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindIfOpExistsQuery>(FindIfOpExistsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'FindIfOpExists', 'query', variables);
    },
    ...
    GetProbeHybSlots(variables: GetProbeHybSlotsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProbeHybSlotsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProbeHybSlotsQuery>(GetProbeHybSlotsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProbeHybSlots', 'query', variables);
    },
    ...
    GetProteinPanels(variables?: GetProteinPanelsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProteinPanelsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProteinPanelsQuery>(GetProteinPanelsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProteinPanels', 'query', variables);
    },
    ...
    GetSectioningComments(variables?: GetSectioningCommentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSectioningCommentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSectioningCommentsQuery>(GetSectioningCommentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSectioningComments', 'query', variables);
    },
