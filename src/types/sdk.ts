...
export type WorkSummaryGroup = {
  ...
  totalLabwareRequired: Scalars['Int'];
};
...
export type WorkSummaryGroupFieldsFragment = { __typename?: 'WorkSummaryGroup', numWorks: number, status: WorkStatus, totalLabwareRequired: number, workType: { __typename?: 'WorkType', name: string, enabled: boolean } };
...
export type GetWorkSummaryQuery = { __typename?: 'Query', worksSummary: Array<{ __typename?: 'WorkSummaryGroup', numWorks: number, status: WorkStatus, totalLabwareRequired: number, workType: { __typename?: 'WorkType', name: string, enabled: boolean } }> };
