...
export type ReactivateLabwareMutationVariables = Exact<{
  request: Array<ReactivateLabware> | ReactivateLabware;
}>;


export type ReactivateLabwareMutation = { __typename?: 'Mutation', reactivateLabware: { __typename?: 'OperationResult', operations: Array<{ __typename?: 'Operation', id: number }> } };
...
export const ReactivateLabwareDocument = gql`
    mutation ReactivateLabware($request: [ReactivateLabware!]!) {
  reactivateLabware(items: $request) {
    operations {
      id
    }
  }
