...
export type PlanAction = {
  ...
  sectioningOrder?: Maybe<Scalars['Int']['output']>;
...
export type PlanRequestAction = {
  ...
  /** An indicator for the order sections are taken from their block. */
  sectioningOrder: Scalars['Int']['input'];
