...
export type ActionFieldsFragment = {
  ...
  sample: {
    ...
    tissue: {
      ...
      replicate?: string | null;
      collectionDate?: string | null;
      donor: { __typename?: "Donor"; donorName: string; lifeStage: LifeStage };
      spatialLocation: {
        __typename?: "SpatialLocation";
        code: number;
        tissueType: { __typename?: "TissueType"; name: string };
...
export type AddFixativeMutation = {
  __typename?: "Mutation";
  addFixative: { __typename?: "Fixative"; name: string; enabled: boolean };
};
...
export type AddWorkTypeMutation = {
  __typename?: "Mutation";
  addWorkType: { __typename?: "WorkType"; name: string; enabled: boolean };
};
...
export type DestroyMutation = {
  ...
  destroy: {
    ...
    destructions: Array<{
      __typename?: "Destruction";
      labware?: { __typename?: "Labware"; barcode: string } | null;
    }>;
  };
};
...
export type SetProjectEnabledMutation = {
  __typename?: "Mutation";
  setProjectEnabled: { __typename?: "Project"; name: string; enabled: boolean };
};
...
export type SetHmdmcEnabledMutation = {
  __typename?: "Mutation";
  setHmdmcEnabled: { __typename?: "Hmdmc"; hmdmc: string; enabled: boolean };
};
...
export type SetSpeciesEnabledMutation = {
  __typename?: "Mutation";
  setSpeciesEnabled: { __typename?: "Species"; name: string; enabled: boolean };
};
...
export type FindLabwareLocationQuery = {
  ...
  stored: Array<{
    __typename?: "StoredItem";
    location: { __typename?: "Location"; barcode: string };
  }>;
};
...
export type FindWorkNumbersQuery = {
  __typename?: "Query";
  works: Array<{ __typename?: "Work"; workNumber: string }>;
};
...
export type GetBlockProcessingInfoQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetPotProcessingInfoQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetFfpeProcessingInfoQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetSampleProcessingCommentsInfoQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetSolutionTransferInfoQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export const RecordSampleProcessingCommentsDocument = gql`
  mutation RecordSampleProcessingComments(
    $request: SampleProcessingCommentRequest!
  ) {
...
export const UpdateWorkNumOriginalSamplesDocument = gql`
  mutation UpdateWorkNumOriginalSamples(
    $workNumber: String!
    $numOriginalSamples: Int
  ) {
    updateWorkNumOriginalSamples(
...
export function getSdk(
  ...
  return {
    ...
    AddExternalID(
      variables: AddExternalIdMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AddExternalIdMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddExternalIdMutation>(
            AddExternalIdDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "AddExternalID",
    ...
    AddSolution(
      variables: AddSolutionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AddSolutionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddSolutionMutation>(AddSolutionDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "AddSolution",
    ...
    PerformSolutionTransfer(
      variables: PerformSolutionTransferMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<PerformSolutionTransferMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PerformSolutionTransferMutation>(
            PerformSolutionTransferDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "PerformSolutionTransfer",
    ...
    PerformTissueBlock(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<PerformTissueBlockMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PerformTissueBlockMutation>(
            PerformTissueBlockDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "PerformTissueBlock",
    ...
    PerformFFPEProcessing(
      variables: PerformFfpeProcessingMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<PerformFfpeProcessingMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PerformFfpeProcessingMutation>(
            PerformFfpeProcessingDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "PerformFFPEProcessing",
    ...
    PerformTissuePot(
      variables: PerformTissuePotMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<PerformTissuePotMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PerformTissuePotMutation>(
            PerformTissuePotDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "PerformTissuePot",
    ...
    RecordSampleProcessingComments(
      variables: RecordSampleProcessingCommentsMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<RecordSampleProcessingCommentsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RecordSampleProcessingCommentsMutation>(
            RecordSampleProcessingCommentsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "RecordSampleProcessingComments",
    ...
    SetSolutionEnabled(
      variables: SetSolutionEnabledMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<SetSolutionEnabledMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetSolutionEnabledMutation>(
            SetSolutionEnabledDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "SetSolutionEnabled",
    ...
    UpdateWorkNumOriginalSamples(
      variables: UpdateWorkNumOriginalSamplesMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UpdateWorkNumOriginalSamplesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateWorkNumOriginalSamplesMutation>(
            UpdateWorkNumOriginalSamplesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "UpdateWorkNumOriginalSamples",
    ...
    GetBlockProcessingInfo(
      variables?: GetBlockProcessingInfoQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetBlockProcessingInfoQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBlockProcessingInfoQuery>(
            GetBlockProcessingInfoDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetBlockProcessingInfo",
    ...
    GetPotProcessingInfo(
      variables?: GetPotProcessingInfoQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetPotProcessingInfoQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPotProcessingInfoQuery>(
            GetPotProcessingInfoDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetPotProcessingInfo",
    ...
    GetFFPEProcessingInfo(
      variables?: GetFfpeProcessingInfoQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetFfpeProcessingInfoQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFfpeProcessingInfoQuery>(
            GetFfpeProcessingInfoDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetFFPEProcessingInfo",
    ...
    GetNextReplicateNumber(
      variables: GetNextReplicateNumberQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetNextReplicateNumberQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetNextReplicateNumberQuery>(
            GetNextReplicateNumberDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetNextReplicateNumber",
    ...
    GetSampleProcessingCommentsInfo(
      variables?: GetSampleProcessingCommentsInfoQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetSampleProcessingCommentsInfoQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSampleProcessingCommentsInfoQuery>(
            GetSampleProcessingCommentsInfoDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetSampleProcessingCommentsInfo",
    ...
    GetSolutionTransferInfo(
      variables?: GetSolutionTransferInfoQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetSolutionTransferInfoQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSolutionTransferInfoQuery>(
            GetSolutionTransferInfoDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetSolutionTransferInfo",
