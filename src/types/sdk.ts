...
export type ProbeLotData = {
  __typename?: 'ProbeLotData';
  /** The name of the probe panel. */
  name: Scalars['String'];
  /** The lot number of the probe. */
  lot: Scalars['String'];
...
export type ProbeLabware = {
  __typename?: 'ProbeLabware';
  barcode: Scalars['String'];
  probes: Array<ProbeLotData>;
};
...
export type Query = {
  ...
  /** Get a probe operation Labware plate, if it exists. May return null. */
  probeHybridisationLabware?: Maybe<ProbeLabware>;
 ...
 * These typically require no user privilege.
 */
export type QueryProbeHybridisationLabwareArgs = {
  barcode: Scalars['String'];
};
...
export type FindProbeHybridisationQueryVariables = Exact<{
  barcode: Scalars['String'];
}>;


export type FindProbeHybridisationQuery = { __typename?: 'Query', probeHybridisationLabware?: { __typename?: 'ProbeLabware', barcode: string } | null };
...
${SlotFieldsFragmentDoc}
${SampleFieldsFragmentDoc}`;
export const FindProbeHybridisationDocument = gql`
    query FindProbeHybridisation($barcode: String!) {
  probeHybridisationLabware(barcode: $barcode) {
    barcode
  }
}
    `;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    FindProbeHybridisation(variables: FindProbeHybridisationQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FindProbeHybridisationQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FindProbeHybridisationQuery>(FindProbeHybridisationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'FindProbeHybridisation', 'query');
    },
