...
export type WorkFieldsFragment = { __typename?: "Work" } & Pick<
  Work,
  "workNumber" | "status" | "numBlocks" | "numSlides"
> & {
...
export function getSdk(
  ...
  return {
    ...
    AddFixative(
      ...
      return withWrapper(() =>
        client.request<AddFixativeMutation>(
          AddFixativeDocument,
          variables,
          requestHeaders
        )
    ...
    AddHmdmc(
      ...
      return withWrapper(() =>
        client.request<AddHmdmcMutation>(
          AddHmdmcDocument,
          variables,
          requestHeaders
        )
    ...
    AddProject(
      ...
      return withWrapper(() =>
        client.request<AddProjectMutation>(
          AddProjectDocument,
          variables,
          requestHeaders
        )
    ...
    AddSpecies(
      ...
      return withWrapper(() =>
        client.request<AddSpeciesMutation>(
          AddSpeciesDocument,
          variables,
          requestHeaders
        )
    ...
    AddWorkType(
      ...
      return withWrapper(() =>
        client.request<AddWorkTypeMutation>(
          AddWorkTypeDocument,
          variables,
          requestHeaders
        )
    ...
    Extract(
      ...
      return withWrapper(() =>
        client.request<ExtractMutation>(
          ExtractDocument,
          variables,
          requestHeaders
        )
    ...
    Plan(
      ...
      return withWrapper(() =>
        client.request<PlanMutation>(PlanDocument, variables, requestHeaders)
      );
    },
    Print(
    ...
    RecordPerm(
      ...
      return withWrapper(() =>
        client.request<RecordPermMutation>(
          RecordPermDocument,
          variables,
          requestHeaders
        )
    ...
    SlotCopy(
      ...
      return withWrapper(() =>
        client.request<SlotCopyMutation>(
          SlotCopyDocument,
          variables,
          requestHeaders
        )
    ...
    Stain(
      ...
      return withWrapper(() =>
        client.request<StainMutation>(StainDocument, variables, requestHeaders)
      );
    },
    StoreBarcode(
    ...
    Unrelease(
      ...
      return withWrapper(() =>
        client.request<UnreleaseMutation>(
          UnreleaseDocument,
          variables,
          requestHeaders
        )
    ...
    ExtractResult(
      ...
      return withWrapper(() =>
        client.request<ExtractResultQuery>(
          ExtractResultDocument,
          variables,
          requestHeaders
        )
      );
    ...
    FindLabware(
      ...
      return withWrapper(() =>
        client.request<FindLabwareQuery>(
          FindLabwareDocument,
          variables,
          requestHeaders
        )
    ...
    FindPassFails(
      ...
      return withWrapper(() =>
        client.request<FindPassFailsQuery>(
          FindPassFailsDocument,
          variables,
          requestHeaders
        )
      );
    ...
    GetPrinters(
      ...
      return withWrapper(() =>
        client.request<GetPrintersQuery>(
          GetPrintersDocument,
          variables,
          requestHeaders
        )
    ...
    GetSearchInfo(
      ...
      return withWrapper(() =>
        client.request<GetSearchInfoQuery>(
    ...
    GetStainInfo(
      ...
      return withWrapper(() =>
        client.request<GetStainInfoQuery>(
          GetStainInfoDocument,
          variables,
          requestHeaders
        )
      );
    ...
    GetWorkTypes(
      ...
      return withWrapper(() =>
        client.request<GetWorkTypesQuery>(
          GetWorkTypesDocument,
          variables,
          requestHeaders
        )
      );
