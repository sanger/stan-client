...
export type Query = {
  ...
  version: VersionInfo;
  releaseColumnOptions: Array<Scalars['String']>;
};
...
export type GetReleaseInfoQuery = { __typename?: 'Query', releaseColumnOptions: Array<string>, releaseDestinations: Array<{ __typename?: 'ReleaseDestination', name: string, enabled: boolean }>, releaseRecipients: Array<{ __typename?: 'ReleaseRecipient', username: string, fullName?: string | null, enabled: boolean }> };

export type GetReleaseColumnOptionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetReleaseColumnOptionsQuery = { __typename?: 'Query', releaseColumnOptions: Array<string> };
