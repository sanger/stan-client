...
export type PlanMutation = { __typename?: "Mutation" } & {
  plan: { __typename?: "PlanResult" } & {
    labware: Array<
      { __typename?: "Labware" } & Pick<Labware, "id" | "barcode"> & {
          slots: Array<
            { __typename?: "Slot" } & {
              samples: Array<
                { __typename?: "Sample" } & Pick<Sample, "section">
              >;
            }
          >;
        }
      ...
      { __typename?: "PlanOperation" } & {
        ...
        planActions: Array<
          { __typename?: "PlanAction" } & Pick<PlanAction, "newSection"> & {
              destination: { __typename?: "Slot" } & Pick<Slot, "labwareId">;
            }
        >;
      }
    >;
...
export type FindLabwareQuery = { __typename?: "Query" } & {
  labware: { __typename?: "Labware" } & Pick<Labware, "barcode"> & {
      ...
      slots: Array<
        { __typename?: "Slot" } & Pick<Slot, "block"> & {
