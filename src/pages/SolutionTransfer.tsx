        ...
        return (
          ...
          >
            {solutionTransferInfo.solutions.map((solution) => (
              <option
                value={solution.name}
                key={`${row.values.barcode}-${solution.name}`}
              >
                {solution.name}
              </option>
            ))}
                  ...
                  <GrayBox>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="mt-2">
                          Please select an SGP number to associate with solution
                          transfer.
                        </p>
                        <motion.div
                          variants={variants.fadeInWithLift}
                      ...
                      >
                        ...
                        ***/
                          ...
                          onAdd={() => {
                            setFieldValue(
                              `labware.${values.labware.length}.solution`,
                              values.applyAllSolution ?? ""
                            );
                          }}
                          onRemove={(labware) => {
                          ...
                          <motion.div variants={variants.fadeInWithLift}>
                            {values.labware.length > 0 && (
                              ...
                              >
                                <FormikSelect
                                  ...
                                  onChange={(
                                    ...
                                    values.labware.forEach((lw, indx) =>
                                      setFieldValue(
                                        `labware.${indx}.solution`,
                                        evt.currentTarget.value
                                      )
                                    );
                                  }}
                                >
                                  {solutionTransferInfo.solutions.map(
                                    (solution) => (
                                      <option
                                        value={solution.name}
                                        key={solution.name}
                                ...
                                <MutedText>
                                  Solution selected will be applied to all
                                  labware
                                </MutedText>{" "}
                              </motion.div>
                            )}
                    ...
                    <Sidebar>
                      ...
                      <div className="my-4 mx-4 sm:mx-auto p-1 rounded-md bg-sdb-400 italic">
                        <p className="my-3 text-white-800 text-xs leading-normal">
                          ...
                          to record solution transfer of samples.
                        </p>
                      </div>
