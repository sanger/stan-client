...
import { GetStainInfoQuery, StainMutation, StainRequest } from "../types/sdk";
 ...
 */
type StainForm = Omit<StainRequest, "timeMeasurements"> & {
              ...
              <Form>
                <GrayBox>
                    ...
                    >
                      ...
                      <FormikSelect
                        ...
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                          setFieldValue("stainType", e.target.value);

                          const timeMeasurements =
                            stainTypeMap.get(e.target.value) ?? [];

                          // Set the timeMeasurements fields to the newly selected stain type's measurements
                          setFieldValue(
                            "timeMeasurements",
                            timeMeasurements.map((name) => ({
                              name,
                              _minutes: 0,
                              _seconds: 0,
                              seconds: 0,
                  ...
                  <Sidebar>
                    ...
                    {values.barcodes.length > 0 && values.stainType !== "" && (
                      <p>
                        <span className="font-semibold">
